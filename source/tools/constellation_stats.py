...
def populate_json(total_satellites, altitude_counts, inclination_counts,constellation_name,json_file="outputs/constellation_history.json",):
    """
    ...
    :param json_file: The path to the JSON file (default is "outputs/constellation_history.json").
